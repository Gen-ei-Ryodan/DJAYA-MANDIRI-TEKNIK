@php
    ...
    $hasHeader = $header || $heading || $description || ($headerActions) || $isReorderable || $areGroupingSettingsVisible || $isGlobalSearchVisible || $hasFilters || count($filterIndicators) || $hasColumnManager;
            ...
            @if (((! $content) && (! $hasColumnsLayout)) || ($records === null) || count($records))
                ...
                >
                    ...
                    @elseif ((! ($content || $hasColumnsLayout)) && ($records !== null))
                        ...
                        >
                            <thead>
                                @if ($isStackedOnMobile && (count($sortableColumns) || ($isSelectionEnabled && ($maxSelectableRecords !== 1) && (! $selectsGroupsOnly))))

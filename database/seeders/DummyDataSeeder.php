...
class DummyDataSeeder extends Seeder
{
    ...
    private function seedArticleCategories(): void
    {
        $categories = [
            ...
            ['name' => 'Berita Perusahaan', 'slug' => 'berita-perusahaan', 'description' => 'Berita dan aktivitas terkini DJAYA MANDIRI TEKNIK.', 'order' => 5],
        ];
    ...
    private function seedArticles(): void
    {
        ...
        $articles = [
            ...
            // Berita Perusahaan
            ['category_slug' => 'berita-perusahaan', 'title' => 'DJAYA MANDIRI TEKNIK Raih Kontrak Proyek Proteksi Petir PLN 150 kV', 'slug' => 'kontrak-pln-150kv', 'excerpt' => 'Kami bangga mengumumkan telah dipercaya oleh PLN untuk mengerjakan sistem grounding dan proteksi petir gardu induk 150 kV.', 'content' => "<h2>Pencapaian Baru</h2><p>DJAYA MANDIRI TEKNIK dengan bangga mengumumkan telah memenangkan tender proyek proteksi petir dan grounding untuk Gardu Induk PLN 150 kV di Sidoarjo, Jawa Timur.</p><h2>Lingkup Pekerjaan</h2><ul><li>Instalasi grounding grid dengan kabel BC 70 mm² total 2.800 meter</li><li>Pemasangan 24 titik ground rod tembaga</li><li>Chemical treatment untuk mencapai resistansi <0.5 ohm</li><li>Pemasangan SPD Type 1 untuk panel utama</li></ul><h2>Komitmen Kami</h2><p>Proyek ini menegaskan komitmen DJAYA MANDIRI TEKNIK dalam memberikan layanan terbaik untuk sektor infrastruktur ketenagalistrikan Indonesia.</p>", 'tags' => ['berita', 'PLN', 'proyek baru', 'gardu induk'], 'read_time' => 4, 'status' => 'published', 'published_at' => '2025-01-10 08:00:00'],
            ['category_slug' => 'berita-perusahaan', 'title' => 'Tim DJAYA MANDIRI TEKNIK Ikuti Sertifikasi Teknisi Proteksi Petir', 'slug' => 'sertifikasi-teknisi-proteksi-petir', 'excerpt' => 'Tim teknisi kami mengikuti program sertifikasi nasional untuk meningkatkan kompetensi di bidang sistem proteksi petir.', 'content' => "<h2>Peningkatan Kompetensi</h2><p>Sebagai komitmen terhadap kualitas layanan, 5 orang teknisi DJAYA MANDIRI TEKNIK telah mengikuti program sertifikasi teknisi proteksi petir yang diselenggarakan oleh Lembaga Sertifikasi Profesi (LSP) Ketenagalistrikan.</p><h2>Materi Sertifikasi</h2><ul><li>Perencanaan sistem proteksi petir berdasarkan SNI</li><li>Teknik instalasi yang benar</li><li>Pengukuran dan pengujian sistem</li><li>Keselamatan kerja (K3) instalasi proteksi petir</li></ul><h2>Manfaat untuk Klien</h2><p>Dengan teknisi bersertifikasi, kami menjamin kualitas instalasi yang sesuai standar, aman, dan dapat dipertanggungjawabkan secara profesional.</p>", 'tags' => ['berita', 'sertifikasi', 'teknisi', 'kompetensi'], 'read_time' => 3, 'status' => 'published', 'published_at' => '2024-12-05 09:00:00'],
        ];
    ...
    {
        $testimonials = [
            ['name' => 'Ir. H. Bambang Sutrisno, MT', 'position' => 'Manager Teknik', 'company' => 'PT Semen Indonesia (Persero) Tbk', 'testimonial' => 'DJAYA MANDIRI TEKNIK mengerjakan proyek proteksi petir di pabrik kami dengan sangat profesional. Tim mereka bekerja cepat, rapi, dan hasil pengukuran grounding menunjukkan resistansi yang sangat baik. Sangat direkomendasikan!', 'rating' => 5, 'order' => 1],
            ['name' => 'dr. Andi Pratama, Sp.Rad', 'position' => 'Kepala Instalasi Radiologi', 'company' => 'RS Premier Surabaya', 'testimonial' => 'Kami sangat khawatir dengan peralatan MRI dan CT Scan yang sangat sensitif terhadap lonjakan listrik. Setelah dipasangi sistem proteksi dari DJAYA MANDIRI TEKNIK, kami merasa lebih tenang. SPD bertingkat yang mereka pasang benar-benar bekerja sempurna.', 'rating' => 5, 'order' => 2],
            ['name' => 'Hendra Wijaya', 'position' => 'General Manager', 'company' => 'PT Ciputra Development Tbk', 'testimonial' => 'Sudah 3 cluster perumahan kami yang menggunakan jasa DJAYA MANDIRI TEKNIK untuk instalasi penangkal petir. Hasilnya rapi, estetik, dan sesuai standar. Harga juga kompetitif. Pasti akan terus bekerja sama.', 'rating' => 5, 'order' => 3],
            ['name' => 'Rudi Hartono', 'position' => 'Kepala Dinas PUPR', 'company' => 'Pemerintah Kabupaten Sidoarjo', 'testimonial' => 'Proyek proteksi petir Stadion Gelora Delta dan beberapa gedung pemerintah daerah kami percayakan ke DJAYA MANDIRI TEKNIK. Pengerjaan tepat waktu, sesuai spesifikasi teknis, dan garansi pelayanan yang baik.', 'rating' => 5, 'order' => 4],
            ['name' => 'Dr. Ir. Ari Wibowo, MT', 'position' => 'VP Engineering', 'company' => 'PT Trans Retail Indonesia', 'testimonial' => 'Trans Icon Mall memerlukan sistem proteksi petir yang handal. DJAYA MANDIRI TEKNIK memberikan solusi lengkap dari survey, perencanaan, instalasi, hingga commissioning. Professional dan responsif!', 'rating' => 5, 'order' => 5],
            ...
            ['name' => 'Maya Sari Dewi', 'position' => 'Site Manager', 'company' => 'PT Gunawangsa Jaya', 'testimonial' => 'Apartemen 20 lantai kami butuh proteksi petir yang handal. DJAYA MANDIRI TEKNIK datang dengan solusi ESE yang efisien. Satu unit saja sudah mencakup seluruh area atap. Sangat membantu menghemat biaya.', 'rating' => 4, 'order' => 7],
            ['name' => 'Agus Prasetyo', 'position' => 'Manager Teknik', 'company' => 'PT Nestle Indonesia', 'testimonial' => 'Standar pabrik makanan global sangat ketat, termasuk untuk proteksi petir. DJAYA MANDIRI TEKNIK mampu memenuhi semua persyaratan dengan baik. Audit internal dan eksternal pun lolos.', 'rating' => 5, 'order' => 8],
            ['name' => 'Prof. Dr. Ir. Muhammad Nuh, DEA', 'position' => 'Rektor', 'company' => 'Universitas Airlangga', 'testimonial' => 'Laboratorium penelitian kami memerlukan sistem grounding dengan resistansi sangat rendah untuk peralatan riset. DJAYA MANDIRI TEKNIK berhasil memenuhi spesifikasi yang sangat ketat tersebut.', 'rating' => 5, 'order' => 9],
            ['name' => 'Dian Permata Sari, ST', 'position' => 'Project Engineer', 'company' => 'Telkomsel Regional Jatim', 'testimonial' => 'Proyek proteksi 20 menara BTS berjalan lancar. Koordinasi tim DJAYA MANDIRI TEKNIK sangat baik, mampu mengerjakan multi-site project dengan kualitas konsisten.', 'rating' => 5, 'order' => 10],
            ['name' => 'H. Ahmad Syafii', 'position' => 'Direktur', 'company' => 'CV Bangun Sarana', 'testimonial' => 'Sebagai kontraktor, kami sering bekerja sama dengan DJAYA MANDIRI TEKNIK untuk subkontrak proteksi petir. Mereka selalu on-time, kualitas bagus, dan harga bersaing. Recommended!', 'rating' => 4, 'order' => 11],
